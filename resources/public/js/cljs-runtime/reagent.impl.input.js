...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__12133){
var map__12134 = p__12133;
var map__12134__$1 = cljs.core.__destructure_map(map__12134);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12134__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__12136 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__12137 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__12137);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__12136);
}}));
} else {
...
(jsprops.onChange = (function (p1__12139_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__12139_SHARP_);
}));
