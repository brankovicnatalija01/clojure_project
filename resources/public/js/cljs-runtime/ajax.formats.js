...
var G__12136 = request;
var G__12137 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__12136,G__12137) : ajax.formats.get_format.call(null, G__12136,G__12137));
} else {
...
return cljs.core.some((function (p1__12143_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__12143_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__12145){
var map__12146 = p__12145;
var map__12146__$1 = cljs.core.__destructure_map(map__12146);
var request = map__12146__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12146__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__12152 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__12152.cljs$core$IFn$_invoke$arity$1 ? fexpr__12152.cljs$core$IFn$_invoke$arity$1(response) : fexpr__12152.call(null, response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__12154){
var map__12155 = p__12154;
var map__12155__$1 = cljs.core.__destructure_map(map__12155);
var request = map__12155__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12155__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__12153_SHARP_){
return ajax.formats.get_accept_entries(request,p1__12153_SHARP_);
