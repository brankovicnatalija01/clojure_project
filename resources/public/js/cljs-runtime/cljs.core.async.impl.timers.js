...
var i_14003 = (self__.level + (1));
while(true){
if((i_14003 <= (new_level + (1)))){
(update[i_14003] = self__.header);

var G__14009 = (i_14003 + (1));
i_14003 = G__14009;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14014 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14014[i]));
} else {
x__$2.forward.push((((i < links_14014.length))?(links_14014[i]):null));
}

if((i < links_14014.length)){
(links_14014[i] = x__$2);
} else {
links_14014.push(x__$2);
}
...
var i_14028 = (0);
while(true){
if((i_14028 <= self__.level)){
var links_14030 = (update[i_14028]).forward;
if((x__$1 === (((i_14028 < links_14030.length))?(links_14030[i_14028]):null))){
(links_14030[i_14028] = (x__$1.forward[i_14028]));

var G__14034 = (i_14028 + (1));
i_14028 = G__14034;
continue;
} else {
var G__14035 = (i_14028 + (1));
i_14028 = G__14035;
continue;
}
} else {
