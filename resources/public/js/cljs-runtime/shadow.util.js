...
var i__5727__auto___13879 = (0);
while(true){
if((i__5727__auto___13879 < len__5726__auto___13877)){
args_arr__5751__auto__.push((arguments[i__5727__auto___13879]));

var G__13885 = (i__5727__auto___13879 + (1));
i__5727__auto___13879 = G__13885;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq13777){
...
var G__13780 = cljs.core.first(seq13777__$2);
var seq13777__$3 = cljs.core.next(seq13777__$2);
var G__13781 = cljs.core.first(seq13777__$3);
var seq13777__$4 = cljs.core.next(seq13777__$3);
var G__13782 = cljs.core.first(seq13777__$4);
var seq13777__$5 = cljs.core.next(seq13777__$4);
var G__13783 = cljs.core.first(seq13777__$5);
var seq13777__$6 = cljs.core.next(seq13777__$5);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13778,G__13779,G__13780,G__13781,G__13782,G__13783,seq13777__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__13843){
var vec__13844 = p__13843;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13844,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13844,(1),null);
